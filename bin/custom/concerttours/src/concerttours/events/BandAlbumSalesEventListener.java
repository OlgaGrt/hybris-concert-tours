...
public class BandAlbumSalesEventListener extends AbstractEventListener<BandAlbumSalesEvent>{
    ...
    @Override
    protected void onEvent(final BandAlbumSalesEvent bandAlbumSalesEvent) {
        final String headline = String.format(BAND_SALES_HEADLINE, bandAlbumSalesEvent.getName());
        final String content = String.format(BAND_SALES_CONTENT, bandAlbumSalesEvent.getName(), bandAlbumSalesEvent.getSales());
